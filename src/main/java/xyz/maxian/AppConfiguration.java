    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "xyz.maxian");
                servletContext.setInitParameter("tapestry.development-modules", "xyz.maxian.services.DevelopmentModule");
